...
import com.qsoft.atdd.common.utils.LogUtils;
...
// ------------------------------ FIELDS ------------------------------
    ...
    private static final String DATABASE_NAME = "atdd.db";
            ...
            PackageManager.NameNotFoundException
    {
        ...
        while (entries.hasMoreElements())
        {
            try
            {
                ...
                {
                    LogUtils.debugLog(GenericDatabaseHelper.class, "Entry: " + entry);
...
// --------------------- GETTER / SETTER METHODS ---------------------
    ...
    public List<Class> getModels() throws URISyntaxException, ClassNotFoundException, PackageManager.NameNotFoundException, IOException
    {
        if (models == null)
        {
            models = getModels(context, context.getPackageName());
        }
        return models;
    }
...
// -------------------------- OTHER METHODS --------------------------
    ...
    public void onUpgrade(SQLiteDatabase db, ConnectionSource connectionSource, int oldVersion, int newVersion)
    {
        ...
        {
            LogUtils.debugLog(this, "Well: " + e.getMessage());
        }
    }
    ...
    {
        // special reflection fu is now handled internally by create com calling the database type
